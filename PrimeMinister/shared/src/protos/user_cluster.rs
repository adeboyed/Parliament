...
pub struct DataRetrievalResponse {
    // message fields
    pub bytes: ::protobuf::RepeatedField<::std::vec::Vec<u8>>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl DataRetrievalResponse {
    ...
    // Param is passed by value, moved
    pub fn set_bytes(&mut self, v: ::protobuf::RepeatedField<::std::vec::Vec<u8>>) {
        self.bytes = v;
    }

    // Mutable pointer to the field.
    pub fn mut_bytes(&mut self) -> &mut ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &mut self.bytes
    }

    // Take field
    pub fn take_bytes(&mut self) -> ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        ::std::mem::replace(&mut self.bytes, ::protobuf::RepeatedField::new())
    }

    pub fn get_bytes(&self) -> &[::std::vec::Vec<u8>] {
        &self.bytes
    }
}
...
impl ::protobuf::Message for DataRetrievalResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_bytes_into(wire_type, is, &mut self.bytes)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
pub struct InputAction {
    // message fields
    pub data_loc_in: ::protobuf::RepeatedField<::std::vec::Vec<u8>>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl InputAction {
    ...
    // Param is passed by value, moved
    pub fn set_data_loc_in(&mut self, v: ::protobuf::RepeatedField<::std::vec::Vec<u8>>) {
        self.data_loc_in = v;
    }

    // Mutable pointer to the field.
    pub fn mut_data_loc_in(&mut self) -> &mut ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &mut self.data_loc_in
    }

    // Take field
    pub fn take_data_loc_in(&mut self) -> ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        ::std::mem::replace(&mut self.data_loc_in, ::protobuf::RepeatedField::new())
    }

    pub fn get_data_loc_in(&self) -> &[::std::vec::Vec<u8>] {
        &self.data_loc_in
    }
}
...
impl ::protobuf::Message for InputAction {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_bytes_into(wire_type, is, &mut self.data_loc_in)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
pub struct WorkerInput {
    // message fields
    pub function_closure: ::std::vec::Vec<u8>,
    pub map_type: WorkerInput_MapType,
    pub datapack: ::protobuf::RepeatedField<::std::vec::Vec<u8>>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl WorkerInput {
    ...
    // .WorkerInput.MapType map_type = 2;

    pub fn clear_map_type(&mut self) {
        self.map_type = WorkerInput_MapType::SINGLE_IN_MULTI_OUT;
    }

    // Param is passed by value, moved
    pub fn set_map_type(&mut self, v: WorkerInput_MapType) {
        self.map_type = v;
    }

    pub fn get_map_type(&self) -> WorkerInput_MapType {
        self.map_type
    }

    // repeated bytes datapack = 3;

    pub fn clear_datapack(&mut self) {
        self.datapack.clear();
    }

    // Param is passed by value, moved
    pub fn set_datapack(&mut self, v: ::protobuf::RepeatedField<::std::vec::Vec<u8>>) {
        self.datapack = v;
    }

    // Mutable pointer to the field.
    pub fn mut_datapack(&mut self) -> &mut ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        &mut self.datapack
    }

    // Take field
    pub fn take_datapack(&mut self) -> ::protobuf::RepeatedField<::std::vec::Vec<u8>> {
        ::std::mem::replace(&mut self.datapack, ::protobuf::RepeatedField::new())
    }

    pub fn get_datapack(&self) -> &[::std::vec::Vec<u8>] {
        &self.datapack
    }
}

impl ::protobuf::Message for WorkerInput {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_repeated_bytes_into(wire_type, is, &mut self.datapack)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.map_type != WorkerInput_MapType::SINGLE_IN_MULTI_OUT {
            my_size += ::protobuf::rt::enum_size(2, self.map_type);
        }
        for value in &self.datapack {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "function_closure",
                    |m: &WorkerInput| { &m.function_closure },
                    |m: &mut WorkerInput| { &mut m.function_closure },
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<WorkerInput_MapType>>(
                    "map_type",
                    |m: &WorkerInput| { &m.map_type },
                    |m: &mut WorkerInput| { &mut m.map_type },
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "datapack",
                    |m: &WorkerInput| { &m.datapack },
                    |m: &mut WorkerInput| { &mut m.datapack },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<WorkerInput>(
                    "WorkerInput",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static WorkerInput {
        static mut instance: ::protobuf::lazy::Lazy<WorkerInput> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const WorkerInput,
        };
        unsafe {
            instance.get(WorkerInput::new)
        }
    }
}

impl ::protobuf::Clear for WorkerInput {
    fn clear(&mut self) {
        self.clear_function_closure();
        self.clear_map_type();
        self.clear_datapack();
...
impl ::protobuf::reflect::ProtobufValue for WorkerInput {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
#[derive(Clone,PartialEq,Eq,Debug,Hash)]
pub enum WorkerInput_MapType {
    SINGLE_IN_MULTI_OUT = 0,
    SINGLE_IN_SINGLE_OUT = 1,
    MULTI_IN_SINGLE_OUT = 2,
}

impl ::protobuf::ProtobufEnum for WorkerInput_MapType {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<WorkerInput_MapType> {
        match value {
            0 => ::std::option::Option::Some(WorkerInput_MapType::SINGLE_IN_MULTI_OUT),
            1 => ::std::option::Option::Some(WorkerInput_MapType::SINGLE_IN_SINGLE_OUT),
            2 => ::std::option::Option::Some(WorkerInput_MapType::MULTI_IN_SINGLE_OUT),
            _ => ::std::option::Option::None
        }
    }

    fn values() -> &'static [Self] {
        static values: &'static [WorkerInput_MapType] = &[
            WorkerInput_MapType::SINGLE_IN_MULTI_OUT,
            WorkerInput_MapType::SINGLE_IN_SINGLE_OUT,
            WorkerInput_MapType::MULTI_IN_SINGLE_OUT,
        ];
        values
    }
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ::protobuf::reflect::EnumDescriptor::new("WorkerInput_MapType", file_descriptor_proto())
            })
        }
    }
}

impl ::std::marker::Copy for WorkerInput_MapType {
}

impl ::std::default::Default for WorkerInput_MapType {
    fn default() -> Self {
        WorkerInput_MapType::SINGLE_IN_MULTI_OUT
    }
}

impl ::protobuf::reflect::ProtobufValue for WorkerInput_MapType {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Enum(self.descriptor())
    }
}
...
impl ::protobuf::Message for WorkerOutput {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "datapacks",
                    |m: &WorkerOutput| { &m.datapacks },
                    |m: &mut WorkerOutput| { &mut m.datapacks },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<WorkerOutput>(
                    "WorkerOutput",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static WorkerOutput {
        static mut instance: ::protobuf::lazy::Lazy<WorkerOutput> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const WorkerOutput,
        };
        unsafe {
            instance.get(WorkerOutput::new)
        }
    }
}

impl ::protobuf::Clear for WorkerOutput {
    fn clear(&mut self) {
...
impl ::protobuf::reflect::ProtobufValue for WorkerOutput {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x03(\x0cR\x05bytes\"-\n\x0bInputAction\x12\x1e\n\x0bdata_loc_in\x18\
    \x01\x20\x03(\x0cR\tdataLocIn\"\xd7\x01\n\tMapAction\x12,\n\x07mapType\
    ...
    \x0b2\n.JobStatusR\x0bjobStatuses\"\xdc\x01\n\x0bWorkerInput\x12)\n\x10f\
    unction_closure\x18\x01\x20\x01(\x0cR\x0ffunctionClosure\x12/\n\x08map_t\
    ype\x18\x02\x20\x01(\x0e2\x14.WorkerInput.MapTypeR\x07mapType\x12\x1a\n\
    \x08datapack\x18\x03\x20\x03(\x0cR\x08datapack\"U\n\x07MapType\x12\x17\n\
    \x13SINGLE_IN_MULTI_OUT\x10\0\x12\x18\n\x14SINGLE_IN_SINGLE_OUT\x10\x01\
    \x12\x17\n\x13MULTI_IN_SINGLE_OUT\x10\x02\",\n\x0cWorkerOutput\x12\x1c\n\
    \tdatapacks\x18\x03\x20\x03(\x0cR\tdatapacks\"\x8e\x01\n\x11ConnectionRe\
    quest\x12\x17\n\x07user_id\x18\x01\x20\x01(\tR\x06userId\x121\n\x06actio\
    n\x18\x02\x20\x01(\x0e2\x19.ConnectionRequest.ActionR\x06action\"-\n\x06\
    Action\x12\r\n\tHEARTBEAT\x10\0\x12\x14\n\x10CLOSE_CONNECTION\x10\x01\"?\
    \n\x12ConnectionResponse\x12)\n\x10request_accepted\x18\x01\x20\x01(\x08\
    R\x0frequestAccepted\"\x87\x01\n\rServerMessage\x12-\n\x06action\x18\x01\
    \x20\x01(\x0e2\x15.ServerMessage.ActionR\x06action\"G\n\x06Action\x12\
    \x10\n\x0cUSER_TIMEOUT\x10\0\x12\x10\n\x0cMISSING_JOBS\x10\x01\x12\x19\n\
    \x15INTERNAL_SERVER_ERROR\x10\x02\"\x86\x03\n\x11SingleUserRequest\x12V\
    \n\x19create_connection_request\x18\x01\x20\x01(\x0b2\x18.CreateConnecti\
    onRequestH\0R\x17createConnectionRequest\x12C\n\x12connection_request\
    \x18\x02\x20\x01(\x0b2\x12.ConnectionRequestH\0R\x11connectionRequest\
    \x127\n\x0ejob_submission\x18\x03\x20\x01(\x0b2\x0e.JobSubmissionH\0R\rj\
    obSubmission\x12M\n\x16data_retrieval_request\x18\x04\x20\x01(\x0b2\x15.\
    DataRetrievalRequestH\0R\x14dataRetrievalRequest\x12A\n\x12job_status_re\
    quest\x18\x05\x20\x01(\x0b2\x11.JobStatusRequestH\0R\x10jobStatusRequest\
    B\t\n\x07request\"\xe6\x03\n\x12SingleUserResponse\x12Y\n\x1acreate_conn\
    ection_response\x18\x01\x20\x01(\x0b2\x19.CreateConnectionResponseH\0R\
    \x18createConnectionResponse\x12P\n\x17job_submission_response\x18\x02\
    \x20\x01(\x0b2\x16.JobSubmissionResponseH\0R\x15jobSubmissionResponse\
    \x12P\n\x17data_retrieval_response\x18\x03\x20\x01(\x0b2\x16.DataRetriev\
    alResponseH\0R\x15dataRetrievalResponse\x12D\n\x13job_status_response\
    \x18\x04\x20\x01(\x0b2\x12.JobStatusResponseH\0R\x11jobStatusResponse\
    \x12F\n\x13connection_response\x18\x05\x20\x01(\x0b2\x13.ConnectionRespo\
    nseH\0R\x12connectionResponse\x127\n\x0eserver_message\x18\x06\x20\x01(\
    \x0b2\x0e.ServerMessageH\0R\rserverMessageB\n\n\x08responseb\x06proto3\
";
